...
function component(width, height, color, x, y, type) {
	...
	if (((myGameArea.frameNo + points) > 8000) && (this == myGamePiece) && (clicked == false) && (this.image.src == ("https://shahu-123.github.io/" + tmntImage))) {
            this.image.src = mbappeImage;
    	} else if (((myGameArea.frameNo + points) > 3000) && (this == myGamePiece) && (clicked == false) && ((this.image.src == ("https://shahu-123.github.io/" + turtleImage)) || (this.image.src == ("https://shahu-123.github.io/" + onturtleImage)))) {
